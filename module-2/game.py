...
if vraag1 == 'a':
    ...
    vraag2 = input("Je klimt op de berg het begint steeds kouder te worden... Je ziet een een grot.. A(in de grot lopen? B(verder lopen?: ")
    if vraag2 == "a":
    ...
    vraag4 = input("Je loopt nu door de bos.. het word best donker... A(Vuurtje maken en ergens slapen B(Door lopen?")
    if vraag4 == "a":
       vraag5 = input("Je bent voor hout aan t zoeken je hoort rare geluiden ga je erop af? (ja of nee)?: ")
       if vraag5 == "ja":
